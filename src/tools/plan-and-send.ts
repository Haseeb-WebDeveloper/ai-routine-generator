...
export const planAndSendRoutine = tool({
  ...
  inputSchema: z
    ...
    .describe("User profile inputs and email; all profile fields are optional and tolerant of free text"),
  execute: async (profile) => {
    try {
      console.log("[TOOL/plan_and_send] === Starting routine planning and email sending ===");
      ...
      console.log("[TOOL/plan_and_send] normalized inputs:", { skinType, skinConcerns, gender, budget, email });
      ...
      console.log("[TOOL/plan_and_send] === Generated summary ===");
      console.log("[TOOL/plan_and_send] summary length:", summary.length);
      console.log("[TOOL/plan_and_send] summary preview:", summary.substring(0, 200) + "...");

      // Now send the email
      console.log("[TOOL/plan_and_send] === Sending email ===");
      console.log("[TOOL/plan_and_send] sending to:", email);
