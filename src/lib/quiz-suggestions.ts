  ...
  switch (questionNumber) {
    ...
    case 7:
      ...
      return [
        {
          text: "Minimal (5 min)",
          value: "Minimal (3-4 steps, 5 minutes max)",
        },
        {
          text: "Standard (10 min)",
          value: "Standard (5-7 steps, 10 minutes)",
        },
        {
          text: "Comprehensive (15+ min)",
          value: "Comprehensive (8+ steps, 15+ minutes)",
        },
      ];
