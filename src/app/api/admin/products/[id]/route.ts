...
import {
  ...
  mapToPrismaTexture,
  mapFromPrismaProductType,
  mapFromPrismaGender,
  mapFromPrismaAgeRange,
  mapFromPrismaBudgetRange,
  mapFromPrismaCategory,
  mapFromPrismaUseTime,
  mapFromPrismaSkinTypes,
  mapFromPrismaSkinConcerns,
  mapFromPrismaTexture,
...
export async function GET(
  ...
  try {
    ...
    const transformedProduct = {
      ...
      name: product.name,
      brand: product.brand,
      type: mapFromPrismaProductType(product.type),
      gender: mapFromPrismaGender(product.gender),
      age: product.age.map(age => mapFromPrismaAgeRange(age)),
      budget: mapFromPrismaBudgetRange(product.budget),
      category: mapFromPrismaCategory(product.category),
      use_time: mapFromPrismaUseTime(product.useTime),
      skin_types: mapFromPrismaSkinTypes(product.skinTypes),
      skin_concerns: mapFromPrismaSkinConcerns(product.skinConcerns),
      ingredients: product.ingredients,
      texture: mapFromPrismaTexture(product.texture),
