...
const components: Options['components'] = {
  ...
  h2: ({ node, children, className, ...props }) => (
    <h2
      className={cn('mt-3 font-semibold text-2xl', className)}
      {...props}
    >
      {children}
    </h2>
  ...
  h4: ({ node, children, className, ...props }) => (
    <h4 className={cn('mt-3 font-semibold text-lg', className)} {...props}>
      {children}
    </h4>
  ),
  h5: ({ node, children, className, ...props }) => (
    <h5
      className={cn('mt-3 font-semibold text-base', className)}
      {...props}
    >
      {children}
    </h5>
  ...
  h6: ({ node, children, className, ...props }) => (
    <h6 className={cn('mt-3 font-semibold text-sm', className)} {...props}>
      {children}
    </h6>
  ),
  ...
  pre: ({ node, className, children }) => {
    ...
    if (
      ...
      code = (children.props as { children?: unknown }).children as string;
